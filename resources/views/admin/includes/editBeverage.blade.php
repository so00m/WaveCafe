					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form  action="{{ route('updateBeverage' , $beverage->id) }}" method="post" enctype="multipart/form-data" 
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6">
												<input type="text" name="title" id="title" required="required" class="form-control" value="{{ old('title', $beverage->title) }}">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div>
												<img src="{{asset('assets/images/'.$beverage->image)}}" width="60%" >
											</div>
										</div>
